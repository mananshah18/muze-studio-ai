...
const openai = new OpenAI({
  apiKey: import.meta.env.VITE_OPENAI_API_KEY || 'YOUR_OPENAI_API_KEY', // Use environment variable
  dangerouslyAllowBrowser: true // Only for client-side use, consider server-side API calls in production
});
